...
void CTableListView::InsertColumnHelper(int nCol, wstring columnName, int nWidth)
{
	CString s;
...
void CTableListView::AddItemHelper(int nItem, int nSubItem, wstring columnName)
{
